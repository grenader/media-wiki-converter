...
docker run --name $2 --link mysql56 -p 80:80 -e MEDIAWIKI_SITE_SERVER=http://dev.wikivedas.com  -e MEDIAWIKI_ADMIN_PASS=11 -e MEDIAWIKI_DB_PASSWORD=11 -e MEDIAWIKI_DB_NAME=mw_db3 -e MEDIAWIKI_DB_USER=root -e MEDIAWIKI_DB_HOST=mysql56 -d $imageId
